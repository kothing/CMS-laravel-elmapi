                    ...
                    <div class="flex">
                        ...
                        <div class="flex border-indigo-600 border border-l-1 border-t-0 border-b-0  border-r-0">
                            <ui-dropdown align="right">
                                <template #trigger>
                                    <button class="bg-indigo-500 hover:bg-indigo-600 items-center px-2 py-2 border border-transparent rounded-md text-sm text-white focus:outline-none transition ease-in-out duration-150 rounded-l-none"><i class="fa fa-sort-down"></i></button>
                                </template>
