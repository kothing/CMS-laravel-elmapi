          ...
          >
            ...
            <router-link
              :to="{
                ...
                params: { id: project.id, col_id: collection.id },
              }"
            ...
            <div class="grid grid-cols-1 gap-4">
              <div class="col-span-12 sm:col-span-12">
                ...
                <input
                  ...
                  v-forminput
                  @input="new_collection.slug = $slugify(new_collection.name)"
                  autofocus
                />
                <p
...
export default {
  ...
  methods: {
    ...
    sortCollections() {
      ...
      axios.post(
        "/admin/collections/update-order/" + this.$route.params.project_id,
