        ...
        <div class="mb-2 p-2 font-bold text-lg flex">
          ...
          <div class="flex ml-1">
            <ui-dropdown align="left">
              <template #trigger>
                <button
                  class="text-indigo-500 hover:bg-gray-100 px-2 rounded-md"
                >
              ...
              <template #content>
                <ui-button
                  ...
                  hover="gray-200"
                  class="w-full h-full"
                  @click.native="openEditCollectionModal = true"
                >
                ...
                <ui-button
                  ...
                  hover="gray-200"
                  class="w-full h-full"
                  @click.native="deleteCollection(collection)"
                >
                  <div class="text-black text-sm text-left">
                    <i class="fa fa-trash-alt text-red-500"></i> Delete
                    Collection
                  </div>
                </ui-button>
              </template>
            ...
            <transition-group type="transition">
              ...
              >
                <div class="flex items-center w-full bg-white rounded-md p-4">
                  ...
                  ></i>
                  <div
                    :class="fieldDetails[field.type].bg"
                    class="mr-4 text-gray-100 rounded-md text-xl items-center text-center flex field_icon_xl"
                  >
                    <i
                      :class="fieldDetails[field.type].icon"
                      class="w-full"
                    ></i>
                  </div>
                  <div class="items-center w-full">
                    ...
                    <div class="w-full flex justify-between">
                      <div class="flex items-center space-x-1">
                        <span
                          class="text-blue-900 text-sm rounded-md bg-gray-200 px-3"
                          >#{{ field.name }}</span
                        >
                        <span
                          class="text-blue-900 text-sm rounded-md bg-indigo-200 px-3"
                        >
                          {{ field.type }}
                          <span v-if="field.type == 'enumeration'">
                            <span v-if="field.options.multiple"
                              >: multiple</span
                            >
                          </span>
                          ...
                          <span v-if="field.type == 'media'">
                            <span v-if="field.options.media.type == 1"
                              >: single</span
                            >
                            <span v-else-if="field.options.media.type == 2"
                              >: multiple</span
                            >
                          </span>
                          <span v-else-if="field.type == 'relation'">
                            <span v-if="field.options.relation.type == 1"
                              >: one-to-one</span
                            >
                            <span v-else-if="field.options.relation.type == 2"
                              >: one-to-many</span
                            >
                          </span>
                        </span>
                        <span
                          class="text-blue-900 text-sm rounded-md bg-gray-100 px-3"
                          v-if="field.validations.required.status"
                          ><i class="fas fa-star-of-life text-xs"></i>
                          required</span
                        >
                        <span
                          class="text-blue-900 text-sm rounded-md bg-gray-100 px-3"
                          v-if="field.validations.unique.status"
                          ><i class="fas fa-fingerprint text-xs"></i>
                          unique</span
                        >
                        <span
                          class="text-blue-900 text-sm rounded-md bg-gray-100 px-3"
                          v-if="field.options.repeatable"
                          ><i class="fas fa-redo text-xs"></i> repeatable</span
                        >
                        <span
                          class="text-blue-900 text-sm rounded-md bg-gray-100 px-3"
                          v-if="field.options.hideInContentList"
                          >hide in content list</span
                        >
                        <span
                          class="text-blue-900 text-sm rounded-md bg-gray-100 px-3"
                          v-if="field.options.hiddenInAPI"
                          >hidden in api</span
                        >
                      </div>
                      ...
                      <div class="flex justify-between space-x-1">
                        ...
                        <a
                          ...
                          class="inline-block text-white text-sm rounded-md bg-red-500 px-3 cursor-pointer hover:bg-red-600 whitespace-nowrap"
                        >
      ...
      <div class="w-3/12 h-full bg-white overflow-x-hidden">
        <div class="h-full p-4" v-if="collection.name">
          ...
          <ul>
            <li class="mb-2">
              <a
                @click="openNewFieldModal('text')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.text.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm items-center text-center flex field_icon"
                  >
            ...
            <li class="mb-2">
              <a
                @click="openNewFieldModal('longtext')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.longtext.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
                  >
            ...
            <li class="mb-2">
              <a
                @click="openNewFieldModal('richtext')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.richtext.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
                  >
            ...
            <li class="mb-2">
              <a
                @click="openNewFieldModal('slug')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.slug.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
                  >
            ...
            <li class="mb-2">
              <a
                @click="openNewFieldModal('email')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.email.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
                  >
            ...
            <li class="mb-2">
              <a
                @click="openNewFieldModal('password')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.password.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
                  >
            ...
            <li class="mb-2">
              <a
                @click="openNewFieldModal('number')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.number.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
                  >
            ...
            <li class="mb-2">
              <a
                @click="openNewFieldModal('enumeration')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.enumeration.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
                  >
            ...
            <li class="mb-2">
              <a
                @click="openNewFieldModal('boolean')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.boolean.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
                  >
            ...
            <li class="mb-2">
              <a
                @click="openNewFieldModal('color')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.color.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
                  >
            ...
            <li class="mb-2">
              <a
                @click="openNewFieldModal('date')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.date.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
                  >
            ...
            <li class="mb-2">
              <a
                @click="openNewFieldModal('time')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.time.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
                  >
            ...
            <li class="mb-2">
              <a
                @click="openNewFieldModal('media')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.media.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
                  >
            ...
            <li class="mb-2">
              <a
                @click="openNewFieldModal('relation')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.relation.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
                  >
            ...
            <li class="mb-2">
              <a
                @click="openNewFieldModal('json')"
                class="block w-full p-2 cursor-pointer hover:bg-gray-100 bg-gray-50 rounded-md"
              >
                <div class="flex">
                  <div
                    :class="fieldDetails.json.bg"
                    class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
                  >
    ...
    <ui-modal :show="openNewFieldModalStatus" @close="closeNewFieldModal">
      <template #title>
        <div class="flex">
          <div>
            <div
              :class="fieldDetails[current_field_type].bg"
              class="mr-2 text-gray-100 rounded-md text-sm p-3 items-center text-center field_icon"
            >
          ...
          <form @submit.prevent="addNewFieldSubmit">
            ...
            <div class="mt-6">
              ...
              <p class="text-sm text-yellow-600 mt-1" v-if="editStatus">
                <i class="fa fa-exclamation-triangle"></i> Changing the field
                name can cause content data loss
              </p>
            ...
            <div class="mt-6">
              ...
              <p
                class="text-sm text-red-600 mt-1"
                v-if="new_field.errors.description"
              >
            ...
            >
              ...
              <p
                class="text-sm text-red-600 mt-1"
                v-if="new_field.errors.placeholder"
              >
              ...
              <div class="mt-6" v-if="slug.field !== null">
                <div class="flex items-start">
                  <div class="flex items-center h-5">
                    <input
                      v-model="new_field.options.slug.readonly"
                      id="readonly"
                      type="checkbox"
                      v-formcheckbox
                    />
                  ...
                  <div class="ml-3 text-sm">
                    <label for="readonly" class="font-medium text-gray-700"
                      >Read Only</label
                    >
            ...
            <div class="mt-6" v-if="current_field_type == 'enumeration'">
              ...
              <div class="clear-both mt-3">
                <p
                  class="text-sm text-red-600 mt-1"
                  v-if="new_field.errors['options.enumeration']"
                >
                  {{ new_field.errors["options.enumeration"][0] }}
                </p>
                <span class="text-red-300" v-if="!enumeration.itemvalid"
                  >! Enter a value</span
                >
              </div>
              <div class="clear-both mt-3">
                <span
                  class="text-gray-600 text-md rounded-md bg-gray-100 py-2 px-3 mr-2"
                  v-for="(item, index) in enumeration.list"
                  :key="index"
                  >{{ item }}
                  <span
                    class="fas fa-times-circle cursor-pointer ml-2 text-gray-300"
              ...
              <div class="w-full mt-5">
                <div class="flex items-start">
                  <div class="flex items-center h-5">
                    <input
                      v-model="new_field.options.multiple"
                      id="required"
                      type="checkbox"
                      v-formcheckbox
                    />
                  ...
                  <div class="ml-3 text-sm">
                    <label for="required" class="font-medium text-gray-700"
            ...
            <div class="mt-6" v-if="current_field_type == 'date'">
              <div class="w-full">
                <div class="flex items-start">
                  <div class="flex items-center h-5">
                    <input
                      v-model="new_field.options.timepicker"
                      id="required"
                      type="checkbox"
                      v-formcheckbox
                    />
            ...
            <div class="mt-6" v-if="current_field_type == 'relation'">
              <div>
                ...
                <v-select
                  ...
                  :get-option-label="
                    (option) => option.name + ' (' + option.slug + ')'
                  "
                ...
                <p
                  class="text-sm text-red-600 mt-1"
                  v-if="new_field.errors['options.relation.collection']"
                >
            ...
            <div class="mt-6">
              ...
              <div class="w-full">
                <div class="flex items-start">
                  <div class="flex items-center h-5">
                    <input
                      v-model="new_field.validations.required.status"
                      id="required"
                      type="checkbox"
                      v-formcheckbox
                    />
                ...
                <div
                  class="w-3/5 block mt-1 ml-7"
                  v-if="new_field.validations.required.status"
                >
                  <input
                    type="text"
                    v-model="new_field.validations.required.message"
              ...
              <div
                class="w-full"
                :class="{ 'opacity-60': new_field.options.repeatable }"
                v-if="
                  current_field_type != 'password' &&
                  current_field_type != 'enumeration' &&
                  current_field_type != 'boolean' &&
              ...
              >
                <div class="flex items-start mt-2">
                  <div class="flex items-center h-5">
                    <input
                      v-model="new_field.validations.unique.status"
                      id="unique"
                      type="checkbox"
                      v-formcheckbox
                      :disabled="new_field.options.repeatable"
                    />
                  </div>
                  <div class="ml-3 text-sm">
                    <label for="unique" class="font-medium text-gray-700"
                      >Unique</label
                    >
                    <p class="text-gray-500">
                      Prevents saving content if there is a record with the same
                      content.
                    </p>
                  </div>
                </div>
                <div
                  class="w-3/5 block mt-1 ml-7"
                  v-if="new_field.validations.unique.status"
                >
                  <input
                    type="text"
                    v-model="new_field.validations.unique.message"
                    placeholder="Custom error message"
                    v-forminput
                  />
                </div>
              ...
              >
                <div class="flex items-start mt-2">
                  <div class="flex items-center h-5">
                    <input
                      v-model="new_field.validations.charcount.status"
                      id="charcount"
                      type="checkbox"
                      v-formcheckbox
                    />
                  ...
                  <div class="ml-3 text-sm">
                    <label for="charcount" class="font-medium text-gray-700">
                      <span v-if="current_field_type != 'number'"
                        >Character count</span
                      >
                      <span v-if="current_field_type == 'number'"
                        >Integer limitations</span
                      >
                    </label>
                    <p
                      class="text-gray-500"
                      v-if="current_field_type != 'number'"
                    >
                ...
                <div
                  class="w-3/5 block mt-1 ml-7"
                  v-if="new_field.validations.charcount.status"
                >
                  <div class="grid grid-cols-5">
                    <div class="col-span-3">
                      <v-select
                        :options="charcount.fields"
                        class="v-select"
                        v-model="new_field.validations.charcount.type"
                        :clearable="false"
                      ></v-select>
                      <p
                        class="text-sm text-red-600 mt-1"
                        v-if="new_field.errors['validations.charcount.type']"
                      >
                    ...
                    <div
                      ...
                      v-if="
                        new_field.validations.charcount.type == 'Between' ||
                        new_field.validations.charcount.type == 'Min'
                      "
                    >
                      <input
                        type="number"
                      ...
                      <p
                        class="text-sm text-red-600 mt-1"
                        v-if="new_field.errors['validations.charcount.min']"
                      >
                    ...
                    <div
                      ...
                      v-if="
                        new_field.validations.charcount.type == 'Between' ||
                        new_field.validations.charcount.type == 'Max'
                      "
                    >
                      <input
                        type="number"
                      ...
                      <p
                        class="text-sm text-red-600 mt-1"
                        v-if="new_field.errors['validations.charcount.max']"
                      >
                ...
                >
                  <input
                    type="text"
                    v-model="new_field.validations.charcount.message"
                    placeholder="Custom error message"
                    v-forminput
                  />
                </div>
            ...
            <div class="mt-6" v-if="current_field_type !== 'password'">
              ...
              <div class="w-full">
                ...
                >
                  <div class="flex items-center h-5">
                    <input
                      v-model="new_field.options.repeatable"
                      id="repeatable"
                      type="checkbox"
                      v-formcheckbox
                    />
                  ...
                  <div class="ml-3 text-sm">
                    <label for="repeatable" class="font-medium text-gray-700"
                ...
                <div class="mt-2 flex items-start">
                  <div class="flex items-center h-5">
                    <input
                      v-model="new_field.options.hideInContentList"
                ...
                <div class="mt-2 flex items-start">
                  <div class="flex items-center h-5">
                    <input
                      v-model="new_field.options.hiddenInAPI"
                      id="hiddenInAPI"
                      type="checkbox"
                      v-formcheckbox
                    />
                  ...
                  <div class="ml-3 text-sm">
                    <label for="hiddenInAPI" class="font-medium text-gray-700"
                      >Hidden in API</label
                    >
      ...
      <template #footer>
        <ui-button
          color="gray-100"
          hover="gray-200"
          @click.native="closeNewFieldModal"
        >
        ...
        <ui-button
          color="indigo-500"
          @click.native="addNewFieldSubmit"
          :class="{ 'opacity-25': processingAddNewField }"
          :disabled="processingAddNewField"
        >
          <span v-if="!editStatus">Add new Field</span>
    ...
    <ui-modal :show="openEditCollectionModal" @close="closeEditCollectionModal">
            ...
            <div class="grid grid-cols-1 gap-4">
              <div class="col-span-12 sm:col-span-12">
                ...
                <p
                  ...
                  v-if="editCollectionData.errors.name"
                >
              ...
              <div class="col-span-12 sm:col-span-12">
                ...
                <input
                  type="text"
                  v-model="editCollectionData.slug"
                  v-forminput
                />
                <p
                  class="text-sm text-red-600 mt-2"
                  v-if="editCollectionData.errors.slug"
                >
      ...
      <template #footer>
        <ui-button
          color="gray-100"
          hover="gray-200"
          @click.native="closeEditCollectionModal"
        >
          <span class="text-gray-800">Cancel</span>
        </ui-button>
  ...
  methods: {
    ...
    addNewFieldSubmit() {
      ...
      if (this.editStatus) {
        axios
          .post(
            "/admin/collections/fields/update/" +
              this.$route.params.project_id +
              "/" +
              this.$route.params.col_id +
              "/" +
        ...
        axios
          .post(
            "/admin/collections/fields/store/" +
              this.$route.params.project_id +
              "/" +
              this.$route.params.col_id,
            this.new_field
    ...
    sortFields() {
      ...
      axios.post(
        "/admin/collections/fields/update-order/" +
          this.$route.params.project_id +
          "/" +
          this.$route.params.col_id,
      ...
      this.$swal
        ...
        .then((result) => {
          if (result.value) {
            axios
              .delete(
                "/admin/collections/fields/delete/" +
                  this.$route.params.project_id +
                  "/" +
                  this.$route.params.col_id +
                  "/" +
