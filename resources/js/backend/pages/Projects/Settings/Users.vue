      ...
      <div class="w-9/12 overflow-x-hidden">
        <div class="p-4">
          ...
          <div class="w-full bg-white mt-2 rounded-md p-4">
            <div
              class="w-full border rounded-md mt-2 overflow-x-auto clear-both"
            >
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr>
                    <td class="px-6 py-3 text-sm align-top">
                      ...
                      <small class="block text-gray-600 text-xs"
                        >Can create and edit collections and content</small
                      >
                    </td>
                    <td class="px-6 py-3 text-sm">
                      ...
                      >
                        <div class="flex items-center">
                          <div>
                            <div
                              class="flex bg-green-500 text-white p-2 text-md rounded-full text-center mr-2 w-9"
                            >
                  ...
                  <tr>
                    <td class="px-6 py-3 text-sm align-top">
                      Editor
                      <small class="block text-gray-600 text-xs"
                        >Can create and edit content</small
                      >
                    </td>
                    <td class="px-6 py-3 text-sm">
                      <div
