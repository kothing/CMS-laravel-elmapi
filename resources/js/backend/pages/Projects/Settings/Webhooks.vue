<template>
  <div class="admin__project-webhooks h-full relative">
      ...
      <div class="w-9/12 overflow-x-hidden">
        <div class="p-4">
          <div class="flex justify-between p-2 items-center">
            ...
            >
              + Create a New Webhook</ui-button
            >
          </div>
                    ...
                    <tr v-for="wh in webhooks" :key="wh.id">
                      ...
                      <td class="px-6 py-3 text-sm whitespace-nowrap">
                        <router-link
                          ...
                          ><i class="fas fa-history mr-2"></i> View
                          Logs</router-link
                        >
                      </td>
                      <td class="px-6 py-3 text-sm">
    ...
    <ui-modal :show="openNewWebhookModal" @close="closeNewWebhookModal">
      <template #title>{{
        !editStatus ? "Create New Webhook" : "Update Webhook"
      }}</template>
            ...
            <form @submit.prevent="createNewWebhookSubmit">
              ...
              <div class="mt-5">
                ...
                <v-select
                  ...
                  :selectable="
                    (selected) =>
                      !new_webhook.data.collection_ids.includes(selected.id)
                  "
              ...
              <div class="mt-5">
                ...
                <v-select
                  ...
                  :clearable="true"
                  :selectable="
                    (selected) => !new_webhook.data.events.includes(selected)
                  "
              ...
              <div class="mt-5">
                ...
                <v-select
                  ...
                  :clearable="true"
                  :selectable="
                    (selected) => !new_webhook.data.sources.includes(selected)
                  "
