<template>
  <div class="admin__project-api h-full relative">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr v-for="token in tokens" :key="token.id">
                      ...
                      <td class="px-6 py-3 text-sm whitespace-nowrap">
                        <span v-show="token.last_used_at !== null">
                          Last Used at
                          {{ token.last_used_at | date("D MMM YYYY, H:mm") }}
                        </span>
                      </td>
                    ...
                    <tr v-if="tokens != undefined && tokens.length === 0">
                      ...
                      >
                        This project does not have tokens yet. In order to
                        access to the API create a new token.
                      </td>
                    </tr>
                  </tbody>
                </table>
    ...
    <ui-modal :show="openNewTokenModal" @close="closeNewTokenModal">
      <template #title>{{
        !editStatus ? "Create New Token" : "Update Token"
      }}</template>
      ...
      <template #content>
        <div class="mt-4">
          <div v-if="showToken">
            <div
              class="rounded bg-orange-100 p-4 text-orange-800 flex items-center items-stretch text-sm leading-5"
            >
              <span class="mr-3"><i class="fa fa-exclamation-circle"></i></span>
              <span>
                Please copy your new API token. For your security, it won't be
                shown again. If you lose this token you can generate a new one.
              </span>
            </div>
            <div
                ...
                <div class="grid grid-cols-2">
                  <div class="col-span-1">
                    <div class="flex items-start">
                      ...
                      <div class="ml-3 text-sm">
                        <label for="create" class="font-medium text-gray-700"
                          >Create</label
                        >
                    ...
                    <div class="flex items-start mt-3">
                      ...
                      <div class="ml-3 text-sm">
                        <label for="update" class="font-medium text-gray-700"
                          >Update</label
                        >
                  ...
                  <div class="col-span-1">
                    <div class="flex items-start">
                      ...
                      <div class="ml-3 text-sm">
                        <label for="read" class="font-medium text-gray-700"
                          >Read</label
                        >
                    ...
                    <div class="flex items-start mt-3">
                      ...
                      <div class="ml-3 text-sm">
                        <label for="delete" class="font-medium text-gray-700"
                          >Delete</label
                        >
