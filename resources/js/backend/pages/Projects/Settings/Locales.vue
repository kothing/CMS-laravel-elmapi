<template>
  <div class="admin__project-locales h-full relative">
          ...
          <div class="w-full bg-white mt-2 rounded-md p-4">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr v-for="locale in project.locales" :key="locale">
                      ...
                      <td
                        class="px-6 py-3 text-sm w-px text-center font-bold whitespace-nowrap"
                      >
            ...
            <div class="mt-10">
              ...
              <div class="flex">
                ...
                <ui-button color="indigo-500" @click.native="addLocale"
                  >+ Add</ui-button
                >
              </div>
            </div>
