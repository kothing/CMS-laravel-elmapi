  ...
  <div class="admin__project-content-table">
    <h4 class="mb-2 font-bold text-lg flex justify-end items-center h-10">
      ...
      <ui-button
        ...
        ><i class="fa fa-link"></i> Add Selected</ui-button
      >
    </h4>
    ...
    <div class="flex space-between">
      <div class="relative flex w-full flex-wrap items-stretch mb-2">
        <span
          class="z-9 h-full leading-snug font-normal absolute text-center text-gray-400 absolute bg-transparent rounded-md text-base items-center justify-center w-8 pl-3 py-2"
        >
            ...
            <div class="border border-gray-200 p-3">
              <div class="flex items-start m-2">
                <div class="flex items-center h-5">
                  <input
                    id="created_at"
                    v-model="columns.created_at"
                    type="checkbox"
                    v-formcheckbox
                    @click="changeColumnSettings()"
                  />
                </div>
                <div class="ml-3 text-sm">
                  <label for="created_at" class="font-medium text-gray-700"
                    >Created At</label
                  >
                </div>
              </div>
              <div class="flex items-start m-2">
                ...
                <div class="ml-3 text-sm">
                  <label for="created_by" class="font-medium text-gray-700"
                    >Created By</label
                  >
                </div>
              </div>
              <div class="flex items-start m-2">
                ...
                <div class="ml-3 text-sm">
                  <label for="updated_at" class="font-medium text-gray-700"
                    >Updated At</label
                  >
                </div>
              </div>
              <div class="flex items-start m-2">
                ...
                <div class="ml-3 text-sm">
                  <label for="updated_by" class="font-medium text-gray-700"
                    >Updated By</label
                  >
                </div>
              </div>
              ...
              <div class="flex items-start m-2">
                ...
                <div class="ml-3 text-sm">
                  <label for="published_by" class="font-medium text-gray-700"
                    >Published By</label
                  >
                </div>
              </div>
              <div v-for="field in collection.fields" :key="field.id">
                <div
                  class="flex items-start m-2"
                  v-if="field.type != 'password' && field.type != 'json'"
                >
                  <div class="flex items-center h-5">
                    <input
                      :id="field.name"
                      v-model="columns[field.name]"
                      type="checkbox"
                      v-formcheckbox
                      @click="changeColumnSettings()"
                    />
          ...
          <table class="min-w-full divide-y divide-gray-200">
              ...
              <tr class="relative">
                ...
                >
                  <div class="w-full flex justify-between item-center">
                    ...
                    <i
                      v-if="
                        listOptions.orderBy == field.name &&
                        listOptions.criteria == 'ASC'
                      "
                      class="fa fa-sort-amount-up-alt text-indigo-500 ml-2"
                    ></i>
                    <i
                      v-if="
                        listOptions.orderBy == field.name &&
                        listOptions.criteria == 'DESC'
                      "
                      class="fa fa-sort-amount-down-alt text-indigo-500 ml-2"
                    ></i>
                  </div>
                </th>
                <th
                ...
                >
                  <div class="w-full flex justify-between item-center">
                    ...
                    <i
                      v-if="
                        listOptions.orderBy == 'created_by' &&
                        listOptions.criteria == 'ASC'
                      "
                      class="fa fa-sort-amount-up-alt text-indigo-500 ml-2"
                    ></i>
                ...
                >
                  <div class="w-full flex justify-between item-center">
                    ...
                    <i
                      v-if="
                        listOptions.orderBy == 'updated_at' &&
                        listOptions.criteria == 'ASC'
                      "
                      class="fa fa-sort-amount-up-alt text-indigo-500 ml-2"
                    ></i>
                ...
                >
                  <div class="w-full flex justify-between item-center">
                    ...
                    <i
                      v-if="
                        listOptions.orderBy == 'updated_by' &&
                        listOptions.criteria == 'ASC'
                      "
                      class="fa fa-sort-amount-up-alt text-indigo-500 ml-2"
                    ></i>
                ...
                >
                  <div class="w-full flex justify-between item-center">
                    ...
                    <i
                      v-if="
                        listOptions.orderBy == 'published_at' &&
                        listOptions.criteria == 'ASC'
                      "
                      class="fa fa-sort-amount-up-alt text-indigo-500 ml-2"
                    ></i>
                ...
                >
                  <div class="w-full flex justify-between item-center">
                    ...
                    <i
                      v-if="
                        listOptions.orderBy == 'published_by' &&
                        listOptions.criteria == 'ASC'
                      "
                      class="fa fa-sort-amount-up-alt text-indigo-500 ml-2"
                    ></i>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="item in content.data" :key="item.id" class="relative">
                    ...
                    <span v-if="meta.field_name == field.name">
                      ...
                      >
                        <span v-if="field.options.timepicker">{{
                          meta.value | date("YYYY-MM-DD hh:mm A")
                        }}</span>
                ...
                <td class="pl-2 py-4 text-sm text-center w-px">
                  <div v-if="item.form_id === null">
                    <span
                      ...
                      class="text-gray-500 rounded-md bg-green-200 px-3 py-1"
                      >published</span
                    >
                    <span
                      v-else
                      class="text-gray-500 rounded-md bg-gray-200 px-3 py-1"
                      >draft</span
                    >
                  </div>
                  <div v-else>
                    <span
                      ...
                      v-tooltip="
                        'Submitted at ' +
                        dateFormat(item.form.created_at) +
                        '. Form name: ' +
                        item.form.name
                      "
                      >published</span
                ...
                <td
                  v-if="columns.created_by"
                  class="px-6 py-3 text-sm w-px whitespace-nowrap text-gray-600 text-center"
                >
                  <div
                    class="bg-green-500 text-white p-2 text-md rounded-full text-center mr-2 w-9"
                    v-tooltip="item.created_by.name"
                  >
                ...
                >
                  <div
                    ...
                    class="bg-green-500 text-white p-2 text-md rounded-full text-center mr-2 w-9"
                    v-tooltip="item.updated_by.name"
                  >
                    <div class="w-full text-center">
                ...
                >
                  <div
                    v-if="item.published_by !== null"
                    class="bg-green-500 text-white p-2 text-md rounded-full text-center mr-2 w-9"
                    v-tooltip="item.published_by.name"
                  >
                    <div class="w-full text-center">
                ...
                <td
                  v-if="listOptions.getItems != 'trashed'"
                  class="position-sticky right-0 px-2 py-4 text-sm w-28 whitespace-nowrap text-center shadow-sm bg-white"
                >
                  <div class="py-2">
                    <router-link
                      :to="{
      ...
      <div class="mt-2 clear-both flex justify-between items-center">
        <div class="block">
          <pagination
            ...
            size="small"
            :limit="3"
            @pagination-change-page="getContent"
          ></pagination>
        </div>

        <div class="text-sm italic text-gray-500">
          {{ content.total }} records, {{ content.from }} -
          {{ content.to }} showing
        </div>
    ...
    >
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tr v-for="item in relationRecords" :key="item.id">
              ...
              <td class="pl-2 py-4 text-sm text-center w-px">
                <span
                  v-if="item.published_at !== null"
                  class="text-gray-500 text-sm rounded-md bg-green-200 px-3 py-1"
                  >published</span
                >
                <span
                  v-else
                  class="text-gray-500 text-sm rounded-md bg-gray-200 px-3 py-1"
                  >draft</span
                >
              </td>
              <td
              ...
              >
                <span v-for="meta in item.meta" :key="meta.id">
                  <span
                    ...
                    :class="{
                      'rounded-md bg-gray-100 p-1 mr-1':
                        JSON.parse(field.options).repeatable &&
                        meta.value !== null,
                    }"
                  >
      ...
      <template #footer>
        <ui-button
          color="gray-100"
          hover="gray-200"
          @click.native="closeRelationModal"
        >
          <span class="text-gray-800">Close</span>
        </ui-button>
      </template>
