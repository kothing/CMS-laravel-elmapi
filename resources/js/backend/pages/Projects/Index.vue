      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 pt-24">
        <div class="col p-4" v-if="checkRole(['admin' + project.id])">
          <div class="inline-flex mb-5">
            <div
              class="mr-4 text-gray-100 bg-yellow-900 rounded-md text-xl p-4 h-full items-center content-center"
            >
            ...
            <div>
              ...
              <div class="text-sm">
                Add new collections to your projects, edit fields to create your
                schema.
              </div>
            </div>
          </div>
        ...
        <div class="col p-4">
          <div class="inline-flex mb-5">
            <div
              class="mr-4 text-gray-100 bg-green-400 rounded-md text-xl p-4 h-full items-center content-center"
            >
            ...
            <div>
              ...
              <div class="text-sm">
                Using the collection schema structure create content for your
                project.
              </div>
            </div>
          </div>
