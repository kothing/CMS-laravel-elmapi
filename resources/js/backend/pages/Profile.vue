    ...
    <div class="w-full custom__xxl:w-3/4 m-auto mt-5 px-4">
        ...
        <form class="space-y-6">
          <div>
            ...
            <div class="mt-1 relative">
              ...
              <p class="text-sm text-red-600 mt-1" v-if="user.errors.name">
                {{ user.errors.name[0] }}
              </p>
            </div>
          </div>
          <div>
            ...
            <div class="mt-1 relative">
              <ui-button :color="'indigo-500'" @click.native="saveName()"
                >Update Name</ui-button
              >
            </div>
          </div>
        </form>
        ...
        <form class="space-y-6">
          <div>
            ...
            <div class="mt-1 relative">
              ...
              <p class="text-sm text-red-600 mt-1" v-if="user.errors.email">
                {{ user.errors.email[0] }}
              </p>
            </div>
          </div>
          <div>
            <label v-formlabel></label>
            <div class="mt-1 relative">
              <ui-button :color="'indigo-500'" @click.native="saveEmail()"
                >Update E-mail</ui-button
              >
            </div>
          </div>
        </form>
      ...
      <div class="w-full bg-white mt-5 rounded-md p-4">
        <div>
          ...
          <div class="mt-1 relative">
            <input
              ...
              v-forminput
            />
            <p class="text-sm text-red-600 mt-1" v-if="user.errors.password">
        ...
        <div>
          <label v-formlabel></label>
          <div class="mt-1 relative">
            <ui-button :color="'indigo-500'" @click.native="savePassword()"
              >Update Password</ui-button
            >
          </div>
        </div>
      </div>
