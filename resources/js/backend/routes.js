...
const Dashboard = () => import(/* webpackChunkName: "backend.dashboard" */ "./pages/Dashboard");
const Profile = () => import(/* webpackChunkName: "backend.profile" */ "./pages/Profile");
const Projects = () => import(/* webpackChunkName: "backend.projects" */ "./pages/Project");
const ProjectIndex = () => import(/* webpackChunkName: "projects.index" */ "./pages/Projects/Index");
const ProjectCollectionIndex = () => import(/* webpackChunkName: "project.collection" */ "./pages/Projects/Collection/CollectionIndex");
...
const ProjectContentIndex = () => import(/* webpackChunkName: "project.content" */ "./pages/Projects/Content/ContentIndex");
...
const ProjectContentMedia = () => import(/* webpackChunkName: "project.content.media" */ "./pages/Projects/Content/Media");
const ProjectSettingsIndex = () => import(/* webpackChunkName: "project.settings" */ "./pages/Projects/Settings/SettingsIndex");
...
const ProjectSettingsWebhookLogs = () => import(/* webpackChunkName: "project.settings.webhookslogs" */ "./pages/Projects/Settings/WebhookLogs");
...
const routes = [
    ...
    {
        path: "/projects/:project_id/collections/:col_id",
    ...
    {
        path: "/projects/:project_id/content/:col_id",
    ...
    {
        path: "/projects/:project_id/content/:col_id/new",
    ...
    {
        path: "/projects/:project_id/content/:col_id/edit/:content_id",
    ...
    {
        path: "/projects/:project_id/content/:col_id/forms",
    ...
    {
        path: "/projects/:project_id/content/:col_id/forms/:form_id",
    ...
    {
        path: "/projects/:project_id/settings/locales",
    ...
    {
        path: "/projects/:project_id/settings/users",
    ...
    {
        path: "/projects/:project_id/settings/api",
    ...
    {
        path: "/projects/:project_id/settings/webhooks",
    ...
    {
        path: "/projects/:project_id/settings/webhooks/:webhook_id/logs",
    ...
    {
        path: "/projects/:project_id/media_library",
